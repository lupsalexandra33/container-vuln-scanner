...
// context cancellation. It is exposed as a variable to allow mocking in tests.
var RunTool = func(ctx context.Context, workingDir string, command string, args ...string) (ExecResult, error) {
